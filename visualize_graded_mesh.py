...
MALLA GRADUAL OPTIMIZADA:
  Zona zapata: dx = 0.25m (refinada)
  Transición gradual: 0.25m → 1.5m (suave)
  Zona superficial: dz = 0.5m
  Transición profunda: 0.5m → 3.3m (gradual)
  Total nodos: 6,069 (62% menos)
  Total superficie: {len(surface_data)}
...
VENTAJAS MALLA GRADUAL:
  ...
  ✓ Df=0: Base zapata en z=0 ✓
  ✓ Dominio 6B: bordes ≈0

PRECISIÓN:
  Diferencia vs malla uniforme: ~11%
  Aceptable para análisis preliminar

NOTA:
  Eje Y INVERTIDO: hundimientos hacia abajo ✓
  Malla gradual óptima para eficiencia.
"""
...
output_file = 'modelo_graded_mesh_6B_20m.png'
