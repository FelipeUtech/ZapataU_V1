...
# Opciones para intentar generar hexaedros
...
# Aplicar recombinación para convertir a hexaedros donde sea posible
print("Recombinando elementos...")
gmsh.model.mesh.recombine()

gmsh.write("mallas/zapata_3D_cuarto_hex.msh")
print("✅ Guardado Gmsh: mallas/zapata_3D_cuarto_hex.msh")
